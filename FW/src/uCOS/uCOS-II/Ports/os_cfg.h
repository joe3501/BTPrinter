...
#define OS_MAX_EVENTS            5//10    /* Max. number of event control blocks in your application      */
...
#define OS_MAX_TASKS             10//20    /* Max. number of tasks in your application, MUST be >= 2       */
